    ...
    <header className="w-full fixed top-0 bg-gradient-to-r from-teal-600 to-teal-800 text-white shadow-lg z-50" role="banner">
      <div className="container mx-auto flex items-center justify-between p-4 relative">
        ...
        <div className="hidden md:flex items-center justify-center flex-grow">
          <div className="bg-teal-700/50 rounded-full px-6 py-2 flex items-center">
            <GraduationCap className="mr-2 h-5 w-5" />
            <h1 className="text-lg font-medium">
              <span className="font-bold">Learn</span> · <span className="font-bold">Build</span> · <span className="font-bold">Connect</span> | Open Campus Education Platform
            </h1>
